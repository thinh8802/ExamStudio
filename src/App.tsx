...
const App: React.FC = () => {
    ...
    const init = async () => {
      try {
        ...
        if (!isProtected && !isManualLock) {
          // Không có mật khẩu và chưa khóa: vào thẳng app
  ...
  // Real-time Live Expiration Heartbeat (Tự động phát hiện hết hạn và chuyển về trang kích hoạt trong thời gian thực)
  React.useEffect(() => {
