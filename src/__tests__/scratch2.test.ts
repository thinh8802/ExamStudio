...
describe('Scratch test 2', () => {
  it('should parse Cau 142 correctly', () => {
    const paragraphs: DocxParagraph[] = [
      ...
      {
        text: 'B. 72.743 triệu đồng',
        runs: [{ text: 'B. 72.743 triệu đồng' }],
      },
      {
        text: 'C. 62.100 triệu đồng',
        runs: [{ text: 'C. 62.100 triệu đồng', highlight: 'yellow', color: 'red' }],
      },
      {
