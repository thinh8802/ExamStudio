...
export const UserGuidePage: React.FC = () => {
  ...
  const chapters: GuideChapter[] = useMemo(() => [
    ...
    },
    {
      id: 'chapter-5',
      chapterNumber: 5,
      title: 'Thiết kế Đề thi & Sinh Đề Ma Trận',
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              description: 'Nhập số lượng mã đề muốn tạo (ví dụ 4 mã đề). Thuật toán sẽ tự động xáo trộn câu hỏi và đáp án ngẫu nhiên, sinh sẵn Bảng đáp án ma trận.'
            }
          ]
        }
      ]
    },
    {
      id: 'chapter-6',
      chapterNumber: 6,
      title: 'Thẻ Ghi Nhớ Flashcard & Spaced Repetition',
      icon: <Sparkles className="w-5 h-5" />,
      color: 'from-cyan-500 to-blue-600',
      description: 'Học từ vựng và công thức với thuật toán lặp lại ngắt quãng SuperMemo SM-2, tự động tạo bộ thẻ từ câu hỏi trắc nghiệm.',
      sections: [
        {
          id: 'c6-flashcard',
          title: '6.1. Thuật toán Lặp lại Ngắt quãng (SM-2 Spaced Repetition)',
          badge: 'Ghi nhớ siêu tốc',
          summary: 'Tối ưu hóa đường cong lãng quên của não bộ: Thẻ khó sẽ xuất hiện thường xuyên hơn, thẻ dễ sẽ giãn cách ngày ôn tập.',
          steps: [
            {
              title: 'Tạo nhanh bộ thẻ từ Ngân hàng câu hỏi',
              description: 'Vào menu "Flashcard" ➔ Bấm "Tạo nhanh từ Câu hỏi" (/flashcards/quick-create) ➔ Chọn Môn và Chương để tự động chuyển thành bộ thẻ học thông minh.'
            }
          ]
        }
      ]
    },
    {
      id: 'chapter-7',
      chapterNumber: 7,
      title: 'Cài Đặt, Tùy Biến, Âm Thanh & Bản Quyền',
      icon: <Settings className="w-5 h-5" />,
      color: 'from-slate-600 to-zinc-800',
      description: 'Tùy chỉnh phím tắt theo sở thích, bộ tạo gradient tự do, âm thanh chuông pha lê sang trọng, quản lý bản quyền offline và sao lưu an toàn.',
      sections: [
        {
          id: 'c7-shortcuts',
          title: '7.1. Tùy Chỉnh Phím Tắt Thao Tác Nhanh (Keyboard Shortcuts Customizer)',
          badge: 'Tùy biến ngón tay',
          summary: 'Tự do gán các phím bấm khi làm bài trắc nghiệm (chọn đáp án, chuyển câu, đánh dấu và xác nhận) theo phong cách quen thuộc của bạn.',
          steps: [
            {
              title: 'Chọn nhanh cấu hình mẫu (Presets)',
              description: 'Trong Cài đặt ➔ Khối "Bảng Phím Tắt Thao Tác Nhanh" ➔ Bấm "Tùy chỉnh nút ấn" ➔ Chọn giữa các cấu hình: 🏆 Mặc định (1-4 & A-D, N/P), ➡️ Phím Mũi Tên (← / →), 🎮 WASD Game (D/A) hoặc 🔤 Chỉ Chữ Cái.'
            },
            {
              title: 'Tùy biến từng phím bấm riêng biệt',
              description: 'Bạn có thể chỉnh phím Chuyển câu (Next), Lùi câu (Prev), Đánh dấu (Flag) và Xác nhận (Confirm) thành bất kỳ phím nào trên bàn phím (N, D, J, L, Space, Enter, M, F...).'
            }
          ]
        },
        {
          id: 'c7-themes',
          title: '7.2. 10 Phối Màu Gradient Độc Quyền & Bảng Tạo Gradient Tự Do',
          badge: 'Giao diện sắc nét',
          summary: 'Hệ thống thiết kế viền nổi bật độ tương phản cao, hỗ trợ 10 bảng màu tuyển chọn cùng trình tạo Gradient 2 điểm màu tự do.',
          steps: [
            {
              title: '10 Theme tuyển chọn',
              description: 'Chọn giữa các theme: Đại Dương Xanh, Tinh Vân Tím, Bạc Hà Tươi Mát, Hoàng Hôn Rực Rỡ, Hồng Magenta, Hổ Phách Hoàng Kim, Băng Lam Bắc Cực, v.v.'
            },
            {
              title: 'Trình tạo Gradient Tự do (Custom Gradient)',
              description: 'Click "Tùy Chỉnh Màu Tự Do" ➔ Chọn 2 điểm màu HEX và góc xoay chuẩn xác (0°, 45°, 90°, 135°, 180°, 270°) kèm các nút góc mẫu 1-chạm.'
            }
          ]
        },
        {
          id: 'c7-sound',
          title: '7.3. Hiệu Ứng Âm Thanh Pha Lê & Nhạc Nền Tập Trung (Audio FX)',
          badge: 'Chuông pha lê sang trọng',
          summary: 'Trải nghiệm âm thanh học tập đẳng cấp với hợp âm chuông pha lê 4 nốt (Major 9th Crystal Harmony) và các dải âm thanh thiên nhiên.',
          steps: [
            {
              title: 'Thanh kéo âm lượng mượt mà & Nút chọn nhanh',
              description: 'Kéo mượt từng 1% hoặc bấm 1-chạm các nút: 🔇 Tắt (0%), 🔉 30%, 🔊 60%, 🔥 100% để đổi âm lượng ngay lập tức.'
            },
            {
              title: 'Âm thanh Thăng Cấp (Level Up Chime)',
              description: 'Được thiết kế tinh tế với 4 nốt pha lê rải nhẹ, bộ lọc âm trầm ấm và độ vang tự nhiên, mang lại cảm giác vinh quang và thư thái.'
            }
          ]
        },
        {
          id: 'c7-license',
          title: '7.4. Kích Hoạt Bản Quyền Offline & Khóa Tự Động Thời Gian Thực',
          badge: 'Bản quyền 100% Offline',
          summary: 'Bảo mật bằng chữ ký số mật mã học Ed25519, hoạt động hoàn toàn Offline không cần Internet.',
          steps: [
            {
              title: 'Kích hoạt License Key',
              description: 'Dán mã bản quyền (dạng EXAMPREP.eyJ...sig...) vào màn hình Kích hoạt để mở khóa vĩnh viễn hoặc dùng thử có thời hạn.'
            },
            {
              title: 'Kiểm tra hết hạn thời gian thực (Live Heartbeat)',
              description: 'Với các mã dùng thử (như 5 phút, 30 ngày), hệ thống tự động đếm ngầm và chuyển về màn hình hết hạn chính xác đến từng giây mà không cần bấm F5.'
            }
          ]
        },
        {
          id: 'c7-backup',
          title: '7.5. Sao Lưu, Khôi Phục Dữ Liệu & Thông Tin Ứng Dụng',
          badge: 'An toàn dữ liệu',
          summary: 'Sao lưu toàn bộ môn học, đề thi và lịch sử ra file JSON để chuyển sang máy tính khác dễ dàng.',
          steps: [
            {
              title: 'Sao lưu & Khôi phục',
              description: 'Vào menu "Sao lưu" (/backup) ➔ Bấm "Tạo file backup JSON" hoặc "Khôi phục dữ liệu từ file JSON".'
            },
            {
              title: 'Thông tin tác giả',
              description: '• Tác giả: Đào Đức Thịnh\n• Facebook: https://www.facebook.com/yoreis06/\n• Gmail: daothinh636@gmail.com'
            }
          ]
        }
      ]
