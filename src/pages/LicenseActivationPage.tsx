// ============================================
// LICENSE ACTIVATION PAGE - ExamPrep Studio
// ============================================
...
export const LicenseActivationPage: React.FC<LicenseActivationPageProps> = ({ onActivated }) => {
  ...
  const { activateLicense, isLoading, error: storeError } = useLicenseStore();
  ...
  const handleActivate = async (e?: React.FormEvent) => {
    ...
    if (!trimmed.startsWith('EXAM.')) {
      setLocalError('Định dạng mã License không đúng (Mã chuẩn phải bắt đầu bằng "EXAM.")');
      return;
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[hsl(var(--background))] p-4 relative overflow-hidden select-none">
      ...
      <div className="max-w-xl w-full relative z-10">
        <div className="rounded-3xl border border-[hsl(var(--border))] bg-[hsl(var(--card))]/90 backdrop-blur-2xl p-6 sm:p-10 shadow-2xl space-y-6">
